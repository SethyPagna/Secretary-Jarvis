...
| `jarvis_cli/terminal.py` | `jarvis meet setup / auth / join / status / transcript / say / stop / node ...` |
...
| `node/jarvis_cli/terminal.py` | v3: `jarvis meet node {run,list,approve,remove,status,ping}` |

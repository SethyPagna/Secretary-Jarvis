...
- **JARVIS installed** — see the [Installation guide](/docs/getting-started/installation)
...
```
Run: gh pr list --repo JARVISProject/jarvis-agent --state open --limit 3
```
...
Run: gh pr diff 3888 --repo JARVISProject/jarvis-agent
```
...
- **[Build a Plugin](/docs/guides/build-a-jarvis-plugin)** — wrap the review logic into a shareable plugin

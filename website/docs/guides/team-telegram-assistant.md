...
- **JARVIS installed** on a server or VPS (not your laptop — the bot needs to stay running). Follow the [installation guide](/docs/getting-started/installation) if you haven't yet.
...
For a full guide, see [Use SOUL.md with Jarvis](/docs/guides/use-soul-with-jarvis).

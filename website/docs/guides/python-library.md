...
Jarvis isn't just a CLI tool. You can import `AIAgent` directly and use it programmatically in your own Python scripts, web applications, or automation pipelines. This guide shows you how.
...
```bash
pip install git+https://github.com/JARVISProject/jarvis-agent.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/JARVISProject/jarvis-agent.git
```

You can also pin it in your `requirements.txt`:

```text
jarvis-agent @ git+https://github.com/JARVISProject/jarvis-agent.git
```
...
For running many prompts in parallel, Jarvis includes `batch_runner.py`. It manages concurrent `AIAgent` instances with proper resource isolation:

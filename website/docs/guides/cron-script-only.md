...
| OS cron + `curl` to a [webhook subscription](/docs/user-guide/messaging/webhooks) | Your script on the OS schedule | When Jarvis might be unhealthy (the thing you're monitoring) |

...
Load a [Jarvis skill](/docs/user-guide/features/skills) to give the agent a consistent review persona. Add `skills` to your route inside `platforms.webhook.extra.routes` in `config.yaml`:
...
- **[Build a Plugin](/docs/guides/build-a-jarvis-plugin)** — package review logic into a shareable plugin

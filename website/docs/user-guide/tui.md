...
Launching `jarvis` (without `--tui`) stays on the classic CLI. To make a machine prefer the TUI, set `JARVIS_TUI=1` in your shell profile. To go back, unset it.

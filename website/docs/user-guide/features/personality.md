...
If the file is empty, whitespace-only, or cannot be read, Jarvis falls back to a built-in default identity ("You are JARVIS, an intelligent AI assistant created by JARVIS Project..."). This fallback also applies when `skip_context_files` is set (e.g., in subagent/delegation contexts).
...
- [SOUL.md Guide](/docs/guides/use-soul-with-jarvis)

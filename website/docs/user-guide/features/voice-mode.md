...
If you want a practical setup walkthrough with recommended configurations and real usage patterns, see [Use Voice Mode with Jarvis](/docs/guides/use-voice-mode-with-jarvis).

## Prerequisites

Before using voice features, make sure you have:

1. **JARVIS installed** — `pip install jarvis-agent` (see [Installation](/docs/getting-started/installation))

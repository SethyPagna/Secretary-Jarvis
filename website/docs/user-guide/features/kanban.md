...
- **Workspace** — the directory a worker operates in. Three kinds:
  - `scratch` (default) — fresh tmp dir under `~/.jarvis/kanban/workspaces/<id>/` (or `~/.jarvis/kanban/boards/<slug>/workspaces/<id>/` on non-default boards).

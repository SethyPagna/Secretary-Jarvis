...
**[references/intake.md](https://github.com/JARVISProject/jarvis-agent/blob/main/optional-skills/creative/kanban-video-orchestrator/references/intake.md)**.
...
**[references/role-archetypes.md](https://github.com/JARVISProject/jarvis-agent/blob/main/optional-skills/creative/kanban-video-orchestrator/references/role-archetypes.md)**.

For mapping role → which Jarvis skills + toolsets it loads, see
**[references/tool-matrix.md](https://github.com/JARVISProject/jarvis-agent/blob/main/optional-skills/creative/kanban-video-orchestrator/references/tool-matrix.md)**.
...
team-design JSON. See **[references/kanban-setup.md](https://github.com/JARVISProject/jarvis-agent/blob/main/optional-skills/creative/kanban-video-orchestrator/references/kanban-setup.md)**
...
playbook, see **[references/monitoring.md](https://github.com/JARVISProject/jarvis-agent/blob/main/optional-skills/creative/kanban-video-orchestrator/references/monitoring.md)**.
...
task graphs. See **[references/examples.md](https://github.com/JARVISProject/jarvis-agent/blob/main/optional-skills/creative/kanban-video-orchestrator/references/examples.md)**.

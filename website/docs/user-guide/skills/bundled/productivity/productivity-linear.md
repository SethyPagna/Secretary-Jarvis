...
2. Set `LINEAR_API_KEY` in your environment (via `jarvis setup` or your env config)
...
The trailing hex segment is the `slugId`. Example: `https://linear.app/jarvisproject/document/rfc-jarvis-permission-gateway-discord-38359beef67c` → `slugId` is `38359beef67c`.

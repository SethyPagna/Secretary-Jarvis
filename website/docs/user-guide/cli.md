...
jarvis -w -q "Fix issue #123"     # Single query in worktree
```

## Interface Layout

<img className="docs-terminal-figure" src="/img/docs/cli-layout.svg" alt="Stylized preview of the Jarvis CLI layout showing the banner, conversation area, and fixed input prompt." />

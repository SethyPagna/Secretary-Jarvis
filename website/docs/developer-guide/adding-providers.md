...
11. `JARVIS_INFERENCE_PROVIDER` env-var override accepts the provider id
...
- OAuth or token refresh (JARVIS Managed, Codex, Google Gemini, Qwen Portal, Copilot)
...
- OAuth / auth-store path: JARVIS Managed, OpenAI Codex

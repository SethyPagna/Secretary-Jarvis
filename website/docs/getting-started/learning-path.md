...
:::tip Start Here
If you haven't installed JARVIS yet, begin with the [Installation guide](/docs/getting-started/installation) and then run through the [Quickstart](/docs/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
7. [Use Voice Mode with Jarvis](/docs/guides/use-voice-mode-with-jarvis)
...
2. [Build a Jarvis Plugin](/docs/guides/build-a-jarvis-plugin)
...
Use reinforcement learning to fine-tune model behavior with JARVIS's built-in RL training pipeline.
...
| **Code Execution** | Run Python scripts that call Jarvis tools programmatically | [Code Execution](/docs/user-guide/features/code-execution) |

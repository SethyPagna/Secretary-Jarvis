  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.footer}>
        ...
        <a
          href="https://github.com/JARVISProject/jarvis-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/JARVISProject" target="_blank" rel="noopener noreferrer">
          JARVIS Project Discord
        </a>{' '}

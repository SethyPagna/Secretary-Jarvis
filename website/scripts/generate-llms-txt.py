...
Both publish at:
  https://jarvis-agent.jarvis.local/docs/llms.txt
  https://jarvis-agent.jarvis.local/docs/llms-full.txt
...
SITE_BASE = "https://jarvis-agent.jarvis.local/docs"
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by JARVIS Project. A terminal-native "
        ...
        "backends. Works with JARVIS Managed, OpenRouter, OpenAI, Anthropic, Google, or any "
        "OpenAI-compatible endpoint."
    )
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/JARVISProject/"
        "jarvis-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/JARVISProject/jarvis-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://jarvis-agent.jarvis.local/docs\n",
        "Short index: https://jarvis-agent.jarvis.local/docs/llms.txt\n",
        "\n---\n\n",
    ]

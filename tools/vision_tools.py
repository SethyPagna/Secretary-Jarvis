...
async def vision_analyze_tool(
    ...
    function (typically tools/model_tools.py) to include both full description
    ...
    try:
        ...
        # Use the prompt as provided (tools/model_tools.py now handles full description formatting)

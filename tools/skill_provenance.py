...
This module exposes a ContextVar that agent/runtime.py sets before each tool
...
_spawn_background_review in agent/runtime.py) and defaults to "assistant_tool"
...
# agent/runtime.py's AIAgent._memory_write_origin override in

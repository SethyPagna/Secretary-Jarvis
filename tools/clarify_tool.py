...
The actual user-interaction logic lives in the platform layer (jarvis_cli/terminal.py for CLI,
...
def clarify_tool(
    ...
    Args:
        ...
        callback: Platform-provided function that handles the actual UI
                  ...
                  Injected by the agent runner (jarvis_cli/terminal.py / gateway).

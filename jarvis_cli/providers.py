...
JARVIS_OVERLAYS: Dict[str, JarvisOverlay] = {
    ...
    "jarvis_managed": JarvisOverlay(
        transport="openai_chat",
        auth_type="oauth_device_code",
        base_url_override="https://inference-api.jarvis.local/v1",
    ),
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    Resolution order:
      1. Jarvis overlays (for providers not in models.dev: jarvis_managed, openai-codex, etc.)

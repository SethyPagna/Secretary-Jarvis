...
Usage:
    python jarvis_cli/terminal.py                          # Start interactive mode with all tools
    python jarvis_cli/terminal.py --toolsets web,terminal  # Start with specific toolsets
    python jarvis_cli/terminal.py --skills jarvis-agent-dev,github-auth
    python jarvis_cli/terminal.py --list-tools             # List available tools and exit
"""
...
def load_cli_config() -> Dict[str, Any]:
    ...
    # gateway/run.py but may lazily import jarvis_cli.terminal as jarvis_cli/terminal.py (triggering this code).
...
class JarvisCLI:
    ...
    def show_toolsets(self):
        ...
        print("  Example: python jarvis_cli/terminal.py --toolsets web,terminal")
        print()
    ...
    def _show_gateway_status(self):
        ...
        try:
            ...
            print("    python jarvis_cli/terminal.py --gateway")
            print()
        ...
        if canonical in {"quit", "exit"}:
            ...
            try:
                ...
                if not plugins:
                    ...
                    print(f"Drop plugin directories into {display_jarvis_home()}/plugins/ to get started.")
                else:
    ...
    def _reload_skills(self) -> None:
        ...
        try:
            ...
            # Sync jarvis_cli/terminal.py's module-level _skill_commands so all consumers
...
def main(
    ...
    Examples:
        python jarvis_cli/terminal.py                            # Start interactive mode
        python jarvis_cli/terminal.py --toolsets web,terminal    # Use specific toolsets
        python jarvis_cli/terminal.py --skills jarvis-agent-dev,github-auth
        python jarvis_cli/terminal.py -q "What is Python?"       # Single query mode
        python jarvis_cli/terminal.py -q "Describe this" --image ~/storage/shared/Pictures/cat.png
        python jarvis_cli/terminal.py --list-tools               # List tools and exit
        python jarvis_cli/terminal.py --resume 20260225_143052_a1b2c3  # Resume session
        python jarvis_cli/terminal.py -w                         # Start in isolated git worktree
        python jarvis_cli/terminal.py -w -q "Fix issue #123"     # Single query in worktree
    """
    global _active_worktree

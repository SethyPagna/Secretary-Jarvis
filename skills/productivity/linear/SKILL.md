...
The trailing hex segment is the `slugId`. Example: `https://linear.app/nousresearch/document/rfc-jarvis-permission-gateway-discord-38359beef67c` → `slugId` is `38359beef67c`.

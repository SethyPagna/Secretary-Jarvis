...
ULTRAPLINIAN_MODELS = [
    ...
    'jarvis-local/jarvis-3-llama-3.1-70b',
    'openai/gpt-4o',
    ...
    'jarvis-local/jarvis-4-405b',
    # POWER TIER (39-49)
    'jarvis-local/jarvis-3-llama-3.1-405b',
    'x-ai/grok-4',
    'z-ai/glm-4.7',
...
def race_godmode_classic(query, api_key=None, timeout=60):
    ...
    HALL_OF_FAME = [
        ...
        {
            'id': 'jarvis-fast',
            'model': 'jarvis-local/jarvis-4-405b',

...
function Show-Doctor {
  ...
  Write-Host "Separate setup lists:"
  Write-Host " - Needed feature downloads: .\scripts\show-setup-lists.ps1"
  Write-Host " - Future scaling models are listed separately in the same command."

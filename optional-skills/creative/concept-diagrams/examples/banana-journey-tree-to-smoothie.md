...
- **Progressive state changes**: Banana color changes (green â†’ yellow â†’ brown â†’ frozen â†’ smoothie)
...
<text x="60" y="40" text-anchor="middle" fill="#185FA5" style="font-size:10px">â„</text>
<!-- Smoke stack -->
...
- **ViewBox**: 850Ã—680 (tall for winding path)

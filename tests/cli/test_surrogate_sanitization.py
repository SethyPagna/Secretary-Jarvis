...
class TestRunConversationSurrogateSanitization:
    ...
    @patch("agent.runtime.AIAgent._build_system_prompt")
    @patch("agent.runtime.AIAgent._interruptible_streaming_api_call")
    @patch("agent.runtime.AIAgent._interruptible_api_call")

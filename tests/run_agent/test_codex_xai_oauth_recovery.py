...
# Jarvis (https://x.ai/news/grok-jarvis), making that hint actively wrong:
...
def test_summarize_api_error_surfaces_xai_entitlement_body_verbatim():
    """xAI's OAuth 403 body must surface as-is, with no Jarvis-side hint."""
    from run_agent import AIAgent
    ...
    # No stale claim that X Premium is incompatible with Jarvis.

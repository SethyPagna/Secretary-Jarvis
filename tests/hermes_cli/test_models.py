...
class TestCheckNousFreeTierCache:
    ...
    @patch("jarvis_cli.models.fetch_nous_account_tier")
    @patch("jarvis_cli.models.is_nous_free_tier", return_value=True)
    def test_result_is_cached(self, mock_is_free, mock_fetch):
        ...
        with patch("jarvis_cli.auth.get_provider_auth_state", return_value={"access_token": "tok"}), \
             patch("jarvis_cli.auth.resolve_nous_runtime_credentials"):
    ...
    @patch("jarvis_cli.models.fetch_nous_account_tier")
    @patch("jarvis_cli.models.is_nous_free_tier", return_value=False)

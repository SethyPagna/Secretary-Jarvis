...
def container_env(tmp_path, monkeypatch):
    ...
    container_mode.write_text(
        ...
        "exec_user=jarvis\n"
        "hermes_bin=/data/current-package/bin/jarvis\n"
    )
    return hermes_home
...
def test_get_container_exec_info_returns_metadata(container_env):
    ...
    assert info["hermes_bin"] == "/data/current-package/bin/jarvis"
...
def test_get_container_exec_info_defaults():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        hermes_home = Path(tmpdir) / ".jarvis"
        hermes_home.mkdir()
        ...
        with patch("jarvis_constants.is_container", return_value=False), \
             patch.dict(get_container_exec_info.__globals__, {"get_jarvis_home": lambda: hermes_home}), \
...
def test_get_container_exec_info_docker_backend(container_env):
    ...
    (container_env / ".container-mode").write_text(
        ...
        "exec_user=myuser\n"
        "hermes_bin=/opt/jarvis/bin/jarvis\n"
    )
    ...
    assert info["hermes_bin"] == "/opt/jarvis/bin/jarvis"

...
class TestParseReasoningConfig(unittest.TestCase):
    ...
    def _parse(self, effort):
        from jarvis_cli.terminal import _parse_reasoning_config
...
class TestReasoningPreviewBuffering(unittest.TestCase):
    ...
    @patch("jarvis_cli.terminal._cprint")
    @patch("jarvis_cli.terminal.shutil.get_terminal_size", return_value=SimpleNamespace(columns=50))
    ...
    @patch("jarvis_cli.terminal.shutil.get_terminal_size", return_value=SimpleNamespace(columns=60))

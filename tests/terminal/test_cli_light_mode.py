...
def cli_mod(monkeypatch):
    ...
    import jarvis_cli.terminal as _cli
...
class TestLightModeDetection:
    ...
    def test_jarvis_light_env_false_forces_dark(self, cli_mod, monkeypatch):
        ...
        monkeypatch.delenv("JARVIS_THEME", raising=False)
        monkeypatch.delenv("JARVIS_BACKGROUND", raising=False)
    ...
    def test_theme_hint_light(self, cli_mod, monkeypatch):
        ...
        monkeypatch.setenv("JARVIS_THEME", "light")
        assert cli_mod._detect_light_mode() is True

    def test_background_hex_hint_light(self, cli_mod, monkeypatch):
        monkeypatch.delenv("JARVIS_LIGHT", raising=False)
        monkeypatch.delenv("JARVIS_THEME", raising=False)
        monkeypatch.setenv("JARVIS_BACKGROUND", "#FFFFFF")
        assert cli_mod._detect_light_mode() is True

    def test_background_hex_hint_dark(self, cli_mod, monkeypatch):
        monkeypatch.delenv("JARVIS_LIGHT", raising=False)
        monkeypatch.delenv("JARVIS_THEME", raising=False)
        monkeypatch.setenv("JARVIS_BACKGROUND", "#1a1a2e")
        monkeypatch.delenv("COLORFGBG", raising=False)
        assert cli_mod._detect_light_mode() is False

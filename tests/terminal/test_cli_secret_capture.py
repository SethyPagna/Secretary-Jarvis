...
import jarvis_cli.terminal as cli_module
...
def test_secret_capture_uses_getpass_without_tui():
    ...
    with patch("jarvis_cli.callbacks.getpass.getpass", return_value="secret-value"), patch(
...
def test_cli_chat_registers_secret_capture_callback():
    ...
    with patch("jarvis_cli.terminal.get_tool_definitions", return_value=[]), patch.dict(

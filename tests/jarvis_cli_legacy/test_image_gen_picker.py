...
class TestConfigWriting:
    ...
    def test_plugin_provider_active_overrides_managed_jarvis_managed_active_label(self, monkeypatch):
        from jarvis_cli import tools_config
        ...
        monkeypatch.setattr(
            ...
            lambda config: SimpleNamespace(
                features={"image_gen": SimpleNamespace(managed_by_jarvis_managed=True)}
            ),
        )
        ...
        assert tools_config._is_provider_active(jarvis_managed_row, config) is False

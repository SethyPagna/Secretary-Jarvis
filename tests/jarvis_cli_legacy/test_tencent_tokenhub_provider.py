...
# =============================================================================
# OpenRouter / JARVIS Managed curated lists
# =============================================================================


class TestTencentInOpenRouterAndJarvisManaged:
    """tencent/hy3-preview:free and tencent/hy3-preview should appear in OpenRouter and JARVIS Managed curated lists."""
    ...
    def test_in_jarvis_managed_provider_models(self):
        from jarvis_cli.models import _PROVIDER_MODELS
        assert "tencent/hy3-preview" in _PROVIDER_MODELS["jarvis_managed"]
...
class TestTencentTokenhubAgentInit:
    ...
    def test_no_syntax_errors(self):
        ...
        import importlib
        importlib.import_module("agent.runtime")

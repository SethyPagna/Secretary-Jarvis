...
def test_oneshot_wires_session_db_for_recall(monkeypatch):
    ...
    from jarvis_cli.oneshot import _run_agent
...
def test_launch_tui_exports_model_provider_and_toolsets(monkeypatch, main_mod):
    ...
    with pytest.raises(SystemExit):
        main_mod._launch_tui(
            model="jarvis_managed/jarvis-test", provider="jarvis_managed", toolsets="web, terminal"
        )

    env = captured["env"]
    assert env["JARVIS_MODEL"] == "jarvis_managed/jarvis-test"
    assert env["JARVIS_INFERENCE_MODEL"] == "jarvis_managed/jarvis-test"
    assert env["JARVIS_TUI_PROVIDER"] == "jarvis_managed"
    assert env["JARVIS_INFERENCE_PROVIDER"] == "jarvis_managed"

...
Complements tests/src/jarvis_cli/test_kanban_db.py (schema + CAS atomicity)
and tests/src/jarvis_cli/test_kanban_jarvis_cli/terminal.py (end-to-end run_slash).  The

...
class TestAggregatorProviders:
    ...
    def test_jarvis_managed_prepends_vendor(self):
        result = normalize_model_for_provider("gpt-5.4", "jarvis_managed")
...
class TestDeepseekVSeriesPassThrough:
    ...
    aggregators (JARVIS Managed portal, OpenRouter via DeepInfra) routes to V3 —

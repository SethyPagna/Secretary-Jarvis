...
def test_delegation_default_toolsets_removed_from_cli_config():
    ...
    Guards against accidental re-introduction in jarvis_cli/terminal.py's CLI_CONFIG default
    ...
    the user's ~/.jarvis/config.yaml over the defaults (jarvis_cli/terminal.py:359-366).
    ...
    (jarvis_cli/terminal.py:76) — before any autouse fixture can fire. Source inspection
    ...
    assert '"default_toolsets"' not in source, (
        ...
        "Do not re-add it to jarvis_cli/terminal.py's CLI_CONFIG default dict; "

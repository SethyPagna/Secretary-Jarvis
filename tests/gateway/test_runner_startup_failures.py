...
async def test_start_gateway_verbosity_imports_redacting_formatter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("jarvis_cli.logging_config.setup_logging", lambda jarvis_home, mode: tmp_path)
    monkeypatch.setattr("jarvis_cli.logging_config._add_rotating_handler", lambda *args, **kwargs: None)

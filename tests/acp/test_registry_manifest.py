...
MANIFEST = ROOT / "ops" / "config" / "acp_registry" / "agent.json"
ICON = ROOT / "ops" / "config" / "acp_registry" / "icon.svg"
...
def test_agent_json_matches_official_registry_required_fields():
    ...
    assert data["website"].startswith("https://github.com/SethyPagna/Secretary-Jarvis")

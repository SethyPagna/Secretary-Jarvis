...
class TestSetupLogging:
    ...
    def test_creates_log_directory(self, hermes_home):
        log_dir = jarvis_logging.setup_logging(hermes_home=hermes_home)
        assert log_dir == hermes_home / "logs"
        assert log_dir.is_dir()

    def test_creates_agent_log_handler(self, hermes_home):
        jarvis_logging.setup_logging(hermes_home=hermes_home)
        root = logging.getLogger()
    ...
    def test_idempotent_no_duplicate_handlers(self, hermes_home):
        jarvis_logging.setup_logging(hermes_home=hermes_home)
        jarvis_logging.setup_logging(hermes_home=hermes_home)  # second call — should be no-op
    ...
    def test_force_reinitializes(self, hermes_home):
        ...
        jarvis_logging.setup_logging(hermes_home=hermes_home, force=True)
    ...
    def test_custom_log_level(self, hermes_home):
        jarvis_logging.setup_logging(hermes_home=hermes_home, log_level="DEBUG")
    ...
    def test_explicit_params_override_config(self, hermes_home):
        ...
        jarvis_logging.setup_logging(hermes_home=hermes_home, log_level="WARNING")
...
class TestGatewayMode:
    ...
    def test_gateway_log_created(self, hermes_home):
        jarvis_logging.setup_logging(hermes_home=hermes_home, mode="gateway")
        root = logging.getLogger()
    ...
    def test_gateway_log_not_created_in_cli_mode(self, hermes_home):
        jarvis_logging.setup_logging(hermes_home=hermes_home, mode="cli")
        root = logging.getLogger()
...
class TestComponentFilter:
    ...
    def test_multiple_prefixes(self):
        f = jarvis_logging._ComponentFilter(("agent", "run_agent", "model_tools"))
...
class TestComponentPrefixes:
    ...
    def test_gateway_prefix(self):
        ...
        # under that prefix).
        assert ("gateway", "hermes_plugins") == jarvis_logging.COMPONENT_PREFIXES["gateway"]

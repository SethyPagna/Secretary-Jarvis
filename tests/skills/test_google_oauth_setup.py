...
class TestHermesConstantsFallback:
    """Tests for _hermes_home.py fallback when jarvis_constants is unavailable."""
    ...
    def _load_helper(self, monkeypatch):
        """Load _hermes_home.py with jarvis_constants blocked."""
    ...
    def test_delegates_to_hermes_constants_when_available(self):
        """When jarvis_constants IS importable, _hermes_home delegates to it."""

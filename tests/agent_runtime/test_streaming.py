...
class TestStreamingAccumulator:
    ...
    @patch("agent.runtime.AIAgent._create_request_openai_client")
    @patch("agent.runtime.AIAgent._close_request_openai_client")
...
class TestAnthropicStreamCallbacks:
    ...
    @patch("agent.runtime.AIAgent._replace_primary_openai_client")
...
class TestCodexFallbackErrorEvent:
    ...
    def test_fallback_surfaces_message_useful_to_summarizer(self):
        ...
        from agent.runtime import AIAgent, _StreamErrorEvent

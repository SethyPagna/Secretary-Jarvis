"""Tests for src/jarvis_cli/terminal.py::_strip_reasoning_tags — specifically the tool-call
...
AIAgent instance. It must stay in sync with src/agent/runtime.py::_strip_think_blocks

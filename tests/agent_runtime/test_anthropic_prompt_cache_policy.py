...
class TestQwenAlibabaFamily:
    ...
    def test_qwen_on_jarvis_managed_portal_caches_with_envelope_layout(self):
        # JARVIS Managed Qwen takes the same envelope-layout cache_control
    ...
    def test_qwen_vendored_slug_on_jarvis_managed_portal_caches(self):
    ...
    def test_non_qwen_non_claude_on_jarvis_managed_portal_does_not_cache(self):

...
class DesktopHomeContractTests(unittest.TestCase):
    ...
    def test_home_voice_records_transcribes_and_dispatches_to_live_terminal(self) -> None:
        ...
        self.assertIn('transcribeVoiceSnapshot(audio, "live")', source)
        ...
        self.assertIn("Listening again shortly", source)
        ...
        self.assertIn("VOICE_SILENT_MONITOR_RESTART_MS", source)

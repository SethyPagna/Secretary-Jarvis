...
class DesktopHomeContractTests(unittest.TestCase):
    ...
    def test_home_voice_records_transcribes_and_dispatches_to_live_terminal(self) -> None:
        ...
        self.assertIn("Voice is still live. Waiting for a clearer signal.", source)
        ...
        self.assertIn("const VOICE_SPEECH_THRESHOLD = 0.028", source)
        self.assertIn("const VOICE_MIN_SPEECH_MS = 360", source)
        self.assertIn("voiceSpeechStartedAtRef", source)
        self.assertIn("const VOICE_AUTO_STOP_SILENCE_MS = 850", source)

...
class TestBrowserSecretExfil:
    ...
    def test_allows_normal_url(self):
        ...
        mock_result = {"success": True, "data": {"title": "ok", "url": "https://github.com/JARVISProject/jarvis-agent"}}
        with patch("tools.browser_tool._run_browser_command", return_value=mock_result), \
            ...
            result = browser_navigate("https://github.com/JARVISProject/jarvis-agent")
        parsed = json.loads(result)

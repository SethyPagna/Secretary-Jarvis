...
class TestRunAgentMultimodalHelpers:
    def test_is_multimodal_tool_result(self):
        from agent.runtime import _is_multimodal_tool_result
    ...
    def test_multimodal_text_summary_prefers_summary(self):
        from agent.runtime import _multimodal_text_summary
    ...
    def test_append_subdir_hint_to_multimodal_appends_to_text_part(self):
        from agent.runtime import _append_subdir_hint_to_multimodal
        env = {
            "_multimodal": True,
            "content": [
                {"type": "text", "text": "summary"},
    ...
    def test_trajectory_normalize_strips_images(self):
        from agent.runtime import _trajectory_normalize_msg
        msg = {
            "role": "tool",
            "tool_call_id": "c1",
            "content": [

...
<text class="charge" x="12" y="-12" fill="#A32D2D" font-weight="bold">âŠ–</text>

<!-- Partial charges (delta notation) -->
<text class="partial" x="0" y="-18" text-anchor="middle" fill="#A32D2D">Î´â»</text>
<text class="partial" x="0" y="-22" text-anchor="middle" fill="#3B6D11">Î´âº</text>
```
...
<text class="chem" x="115" y="-60" fill="var(--text-primary)">â€¡</text>
```
...
<text class="ts" x="250" y="30" text-anchor="middle" fill="#534AB7" font-weight="500">Transition State [â€¡]</text>
...
<text class="chem-sm">OHâ»</text>  <!-- Using Unicode superscript minus -->
<text class="chem-sm">CHâ‚ƒBr</text>  <!-- Using Unicode subscript 3 -->
```
...
- **ViewBox**: 800Ã—680 (landscape for mechanism + energy profile)
- **Mechanism section**: y=60-300, showing reactants â†’ TS â†’ products

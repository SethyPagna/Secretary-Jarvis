...
- [x] 43.2 Prefer local venv Python for Gateway voice/vision probes - commit `pending`
...
Next task: Phase 43.3, add local venv lifecycle to the voice setup assistant.

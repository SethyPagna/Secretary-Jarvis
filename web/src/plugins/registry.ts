...
import { Tabs, TabsList, TabsTrigger } from "@jarvis_managed-research/ui/ui/components/tabs";
...
export function exposePluginSDK() {
  ...
  window.__JARVIS_PLUGIN_SDK__ = {
    ...
    // UI components — JARVIS Managed DS where available, shadcn/ui primitives elsewhere.
    components: {
      Card,
      CardHeader,
      CardTitle,

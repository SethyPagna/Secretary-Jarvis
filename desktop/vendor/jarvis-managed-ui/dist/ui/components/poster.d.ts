 ...
 *   marks and a tiny "JARVIS Agent" mark in the corner — mirrors the
 *   overlay on the JARVIS Agent website.
...
export interface PosterProps {
    ...
    /**
     * Signature mark. In `vibe` this is the small "JARVIS Agent" overlay in the
     * bottom-right. In `dispatch` this is the URL / CTA in the footer.
     */
    signature?: React.ReactNode;
    /** Override the poster image. Defaults to the JARVIS "filler-bg0" asset. */
    src?: string;

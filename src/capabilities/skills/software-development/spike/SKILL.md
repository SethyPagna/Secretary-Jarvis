...
**Avoid** unless the spike specifically requires it: complex package management, build src/tools/bundlers, Docker, env files, config systems. Hardcode everything — it's a spike.

...
- **Horizontal flow within container**: Post-production shows sequential pipeline with arrows (Editing â†’ Color â†’ VFX â†’ Sound â†’ Score)
...
- **ViewBox**: 680Ã—780 (standard width, tall for 5 phases)
...
- **Inner node dimensions**: 160Ã—36px for standard tasks, variable width for post-production sequential flow

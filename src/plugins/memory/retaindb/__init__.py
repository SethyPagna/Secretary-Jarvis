...
class _Client:
    ...
    def get_agent_model(self, agent_id: str) -> dict:
        return self.request("GET", f"/v1/memory/src/agent/{quote(agent_id, safe='')}/model", params={"project": self.project}, timeout=4.0)

    def seed_agent_identity(self, agent_id: str, content: str, source: str = "soul_md") -> dict:
        return self.request("POST", f"/v1/memory/src/agent/{quote(agent_id, safe='')}/seed", json_body={

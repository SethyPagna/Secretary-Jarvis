...
- Snapshot persisted at `~/.jarvis/src/plugins/jarvis-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.jarvis/src/plugins/jarvis-achievements/scan_checkpoint.json`.

...
- persisted runtime files:
  - `~/.jarvis/src/plugins/jarvis-achievements/state.json` (existing unlock state)
  - `~/.jarvis/src/plugins/jarvis-achievements/scan_snapshot.json` (new)
  - `~/.jarvis/src/plugins/jarvis-achievements/scan_checkpoint.json` (new)

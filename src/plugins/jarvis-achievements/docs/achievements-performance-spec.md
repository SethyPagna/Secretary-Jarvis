...
### `GET /api/src/plugins/jarvis-achievements/achievements`
...
### `POST /api/src/plugins/jarvis-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/src/plugins/jarvis-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/src/plugins/jarvis-achievements/overview`
...
- Persist plugin data under:
  - `~/.jarvis/src/plugins/jarvis-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.jarvis/src/plugins/jarvis-achievements/scan_checkpoint.json`
...
- `~/.jarvis/src/plugins/jarvis-achievements/`

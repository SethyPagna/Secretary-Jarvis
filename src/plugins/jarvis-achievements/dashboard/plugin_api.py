...
Mounted at /api/src/plugins/jarvis-achievements/ by Jarvis dashboard.
"""
...
ACHIEVEMENTS: List[Dict[str, Any]] = [
    ...
    # Model Lore
    {"id": "model_hopper", "name": "Model Hopper", "description": "Switch or inspect src/providers/models enough to count as a habit.", "category": "Model Lore", "kind": "lifetime", "icon": "swap", "threshold_metric": "model_events", "tiers": tiers([10000, 30000, 80000, 200000, 500000])},
...
def model_provider(model_name: str) -> Optional[str]:
    ...
    for provider in ["openai", "anthropic", "google", "gemini", "mistral", "meta", "qwen", "deepseek", "xai", "jarvis_managed", "ollama", "groq", "openrouter", "codex"]:
        if provider in name:
...
METRIC_LABELS = {
    ...
    "gateway_events": "src/gateway/API/chat-platform activity",

...
submission, managed-JARVIS Managed-gateway selection, Clarity Upscaler chaining
...
* the existing test suite (``tests/src/tools/test_image_generation.py``,
  ``tests/src/tools/test_managed_media_gateways.py``) keeps patching
...
class FalImageGenProvider(ImageGenProvider):
    ...
    def is_available(self) -> bool:
        # Available when direct FAL_KEY is set OR the managed JARVIS Managed

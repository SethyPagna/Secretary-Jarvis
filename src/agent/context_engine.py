...
``src/plugins/context_engine/<name>/`` directory.
...
class ContextEngine(ABC):
    ...
    # -- Token state (read by src/agent/runtime.py for display/logging) ------------
    #
    # Engines MUST maintain these. src/agent/runtime.py reads them directly.
    ...
    # -- Compaction parameters (read by src/agent/runtime.py for preflight) --------
    #
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        Default returns the standard fields src/agent/runtime.py expects.
        """
        return {

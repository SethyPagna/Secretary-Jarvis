...
handled separately in ``src/tools/mcp_tool._normalize_mcp_input_schema`` so it
...
def is_moonshot_model(model: str | None) -> bool:
    ...
    prefixed slugs (``jarvis_managed/moonshotai/kimi-k2.6``, ``openrouter/moonshotai/...``).
    Detection by model name covers JARVIS Managed / OpenRouter / other aggregators that

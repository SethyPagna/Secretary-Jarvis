...
Architecture mirrors `src/agent/bedrock_adapter.py`:
...
class EntraIdentityConfig:
    ...
    ``src/jarvis_cli/runtime_provider.py:1310-1377`` for the analogous
...
def materialize_bearer_for_http(value: Any) -> str:
    ...
    header outside the OpenAI SDK (e.g. ``src/jarvis_cli/azure_detect.py``).

...
Extracted from src/agent/runtime.py to isolate Responses API-specific logic from the
...
def _normalize_codex_response(response: Any) -> tuple[Any, str]:
    ...
    # handled in src/agent/runtime.py) gets a chance to re-elicit a proper

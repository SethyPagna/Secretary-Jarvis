...
that the main retry loop in src/agent/runtime.py consults for every API failure.
"""
...
def classify_api_error(
    ...
    *,
    ...
    # in src/agent/runtime.py rebuilds the Anthropic client with the beta stripped
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # the retryability check in src/agent/runtime.py.  If those succeed, the

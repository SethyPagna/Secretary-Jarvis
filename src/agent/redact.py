...
# (bridged to this env var in src/jarvis_cli/main.py, src/gateway/run.py, and
# src/jarvis_cli/terminal.py) or `JARVIS_REDACT_SECRETS=false` in ~/.jarvis/.env. An opt-out
# warning is logged at gateway and CLI startup so operators see the
# downgrade — see `_log_redaction_status()` in src/gateway/run.py and src/jarvis_cli/terminal.py.

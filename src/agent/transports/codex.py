...
Delegates to the existing adapter functions in src/agent/codex_responses_adapter.py.
    ...
    def build_kwargs(
        ...
        **params,
        ...
        if reasoning_enabled and is_xai_responses:
            ...
            # See src/agent/codex_responses_adapter._chat_messages_to_responses_input

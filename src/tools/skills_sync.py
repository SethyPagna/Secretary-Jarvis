...
Copies bundled skills from the repo's src/capabilities/skills/ directory into ~/.jarvis/skills/
...
from jarvis_cli.constants import get_bundled_skills_dir, get_jarvis_home

...
Used by src/jarvis_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
class OptionalSkillSource(SkillSource):
    """
    Fetch skills from the src/capabilities/optional-skills/ directory shipped with the repo.
...
JARVIS_INDEX_URL = "https://raw.githubusercontent.com/SethyPagna/Secretary-Jarvis/main/ops/docs/api/skills-index.json"
...
def _load_jarvis_index() -> Optional[dict]:
    ...
    The index is a JSON file committed under ops/docs/api and rebuilt by maintainers.
    ...
    # Fetch from repo-hosted ops/docs/api manifest
    try:
...
class JarvisIndexSource(SkillSource):
    ...
    The index is a JSON catalog published under ops/docs/api and rebuilt

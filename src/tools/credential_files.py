...
# Each tuple is (new_subpath, old_name) matching jarvis_cli.constants.get_jarvis_dir().
...
def to_agent_visible_cache_path(
    ...
    # (same env var src/tools/terminal_tool.py reads in _get_environment_config).

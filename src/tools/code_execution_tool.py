...
def _load_config() -> dict:
    ...
    lightweight raw config instead; the config layer already caches by (mtime, size), and an absent
...
# current configured mode).  src/tools/model_tools.py rebuilds per-session anyway.

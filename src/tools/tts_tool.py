...
def _generate_neutts(text: str, output_path: str, tts_config: Dict[str, Any]) -> str:
    ...
    Runs synthesis in a subprocess via src/tools/neutts_synth.py to keep the
...
# Markdown stripping patterns (same as src/jarvis_cli/terminal.py _voice_speak_response)

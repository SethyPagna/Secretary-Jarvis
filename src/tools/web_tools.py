...
# (tests/src/tools/test_web_tools_tavily.py imports these names directly).
...
# unit tests (tests/src/tools/test_web_tools_config.py imports _get_parallel_client
...
#   - parallel: src/plugins/web/parallel/provider.py
#   - tavily:   src/plugins/web/tavily/provider.py
#   - firecrawl: src/plugins/web/firecrawl/provider.py
    ...
    for attempt in range(max_retries):
        try:
            ...
            call_kwargs = {
                ...
                # src/agent/auxiliary_client.py). Users with slow local models should set
...
#   - src/plugins/web/exa/provider.py
#   - src/plugins/web/parallel/provider.py

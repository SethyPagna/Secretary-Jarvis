...
def _is_gateway_approval_context() -> bool:
    """True when this call is inside a src/gateway/API session.
...
def prompt_dangerous_approval(command: str, description: str,
    ...
    # before reaching this point (see delegate_tool.py, src/agent/runtime.py
...
def check_dangerous_command(command: str, env_type: str,
    ...
    if is_truthy_value(os.getenv("JARVIS_YOLO_MODE")) or is_current_session_yolo_enabled():
        return {"approved": True, "message": None}
...
def check_all_command_guards(command: str, env_type: str,
    ...
    if is_truthy_value(os.getenv("JARVIS_YOLO_MODE")) or is_current_session_yolo_enabled() or approval_mode == "off":
        return {"approved": True, "message": None}
    ...
    # Preserve the existing non-interactive behavior: outside CLI/src/gateway/ask
    ...
    if is_gateway or is_ask:
        ...
        if notify_cb is not None:
            ...
            # in src/tools/environments/base.py.

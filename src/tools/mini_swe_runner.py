...
compatible with src/tools/batch_runner.py and src/tools/trajectory_compressor.py.
...
# ============================================================================
# Terminal Tool Definition (matches Jarvis-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Jarvis-Agent's built-in backends.
...
class MiniSWERunner:
    """
    Agent runner that uses Jarvis-Agent's built-in execution environments
    and outputs trajectories in Jarvis-Agent format.
    """
    ...
    def _convert_to_jarvis_format(
        ...
        This produces the exact format used by src/tools/batch_runner.py.
        """
        trajectory = []

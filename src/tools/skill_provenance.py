...
This module exposes a ContextVar that src/agent/runtime.py sets before each tool
...
_spawn_background_review in src/agent/runtime.py) and defaults to "assistant_tool"
...
# src/agent/runtime.py's AIAgent._memory_write_origin override in

...
Log files produced:
    agent.log   — INFO+, all src/agent/tool/session activity (the main log)
...
from jarvis_cli.constants import get_config_path, get_jarvis_home
...
class _ManagedRotatingFileHandler(RotatingFileHandler):
    ...
    inherit the jarvis group. However, both _open() (initial creation) and

...
def do_browse(page: int = 1, page_size: int = 20, source: str = "all",
    ...
    if official_count > 0 and page == 1:
        c.print(f"[bright_cyan]★ {official_count} official optional JARVIS skill(s)[/]")
    c.print()
    ...
    c.print("[dim]Tip: 'jarvis skills search <query>' searches deeper across all registries[/]\n")
...
def do_install(identifier: str, category: str = "", force: bool = False,
    ...
    if not force and not skip_confirm:
        ...
        if bundle.source == "official":
            c.print(Panel(
                "[bold bright_cyan]This is an official optional JARVIS skill.[/]\n\n"
...
def skills_command(args) -> None:
    """Router for `jarvis skills <subcommand>` — called from src/jarvis_cli/main.py."""
    ...
    if action == "browse":
        ...
        _console.print("Usage: jarvis skills [browse|search|install|inspect|list|check|update|audit|uninstall|reset|publish|snapshot|tap]\n")

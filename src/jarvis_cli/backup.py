...
_EXCLUDED_DIRS = {
    ...
    "node_modules",     # js deps if local frontend/vendor deps leak in
...
def run_backup(args) -> None:
    ...
    for dirpath, dirnames, filenames in os.walk(jarvis_root, followlinks=False):
        ...
        for fname in filenames:
            ...
            # Skip the output zip itself if it happens to be inside jarvis root
            try:
...
_QUICK_STATE_FILES = (
    ...
    "pairing",                          # legacy location (src/gateway/pairing.py)
    "platforms/pairing",                # new location (src/gateway/pairing.py)

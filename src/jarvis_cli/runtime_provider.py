...
def resolve_requested_provider(requested: Optional[str] = None) -> str:
    ...
    env_provider = os.getenv("JARVIS_INFERENCE_PROVIDER", "").strip().lower()
    if env_provider:
        return env_provider
...
def _get_named_custom_provider(requested_provider: str) -> Optional[Dict[str, Any]]:
    ...
    if not requested_norm.startswith("custom:"):
        try:
            ...
            # the built-in. See tests/src/jarvis_cli/test_runtime_provider_resolution.py
    ...
    *,
    ...
    if provider == "anthropic":
        ...
        if _is_azure_endpoint:
            ...
            # Matches the config.yaml examples in ops/docs/local-model-downloads.md.
            token = ""

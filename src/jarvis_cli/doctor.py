...
def _build_apikey_providers_list() -> list:
    ...
    already present — adding src/plugins/model-providers/<name>/ is sufficient to get into doctor.
    """
    _static = [
        ...
        ("Kilo Code",        ("KILOCODE_API_KEY",),                          "https://api.kilo.ai/api/src/gateway/models", "KILOCODE_BASE_URL", True),
...
def run_doctor(args):
    ...
    if terminal_env == "vercel_sandbox":
        ...
        if importlib.util.find_spec("vercel") is not None:
            ...
            _fail_and_issue(
                ...
                "Install the Vercel optional dependency: pip install 'jarvis-agent[vercel]'",
                issues,
            )
    ...
    if _safe_which("node"):
        ...
        # (src/tools/browser_tool.py::check_browser_requirements filters them out

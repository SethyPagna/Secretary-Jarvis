...
Relies on src/tools/mcp_tool.py for connection/discovery and keeps
...
def cmd_mcp_add(args):
    ...
    # src/jarvis_cli/main.py for why the dest is renamed.
...
def mcp_command(args):
    ...
    if action == "serve":
        from jarvis_cli.mcp_server import run_mcp_server
    ...
    if handler:
        ...
        _info("jarvis mcp add <name> --url <endpoint>        Add an MCP server")
        ...
        _info("jarvis mcp list                               List servers")

...
class CommandDef:
    ...
    gateway_only: bool = False         # only available in src/gateway/messaging
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("insights", "Show usage insights and analytics", "Info",
               args_hint="[days]"),
    CommandDef("platforms", "Show src/gateway/messaging platform status", "Info",
...
# Commands with explicit Level-2 running-agent handlers in src/gateway/run.py.
...
def should_bypass_active_session(command_name: str | None) -> bool:
    ...
    specific Level-2 handler in src/gateway/run.py (/stop, /new, /model,
...
def discord_skill_commands_by_category(
    ...
    *uncategorized*.
    ...
    (``_register_skill_group`` in ``src/gateway/platforms/discord.py``, refactored

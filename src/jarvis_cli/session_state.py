...
# src/jarvis_cli/kanban_db.py for ~30 call sites) would re-log the same
...
def _log_wal_fallback_once(db_label: str, exc: Exception) -> None:
    ...
    connection on every operation — see src/jarvis_cli/kanban_db.py) would
...
class SessionDB:
    ...
    def vacuum(self) -> None:
        ...
        active. Safe to call at startup before the src/gateway/CLI starts
        serving traffic.
        """

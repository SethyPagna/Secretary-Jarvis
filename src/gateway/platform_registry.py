...
class PlatformEntry:
    ...
    # YAML config translation instead of forcing core ``src/gateway/config.py``
    ...
    # See ops/docs/jarvis/social-media-and-platforms.md for the
    # full contract and a worked example.
    apply_yaml_config_fn: Optional[Callable[[dict, dict], Optional[dict]]] = None

    # Optional: home-channel env var name for src/cron/notification delivery
    ...
    # gateway adapter.  Called by ``src/tools/send_message_tool._send_via_adapter``

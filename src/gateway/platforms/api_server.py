...
class APIServerAdapter(BasePlatformAdapter):
    ...
    and routes them through jarvis-agent's AIAgent.
    """
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # Active run src/agent/task references for stop support
    ...
    async def _handle_health(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({"status": "ok", "platform": "jarvis-agent"})
    ...
    async def _handle_capabilities(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({
            ...
            "runtime": {
                ...
                "split_runtime": False,
                "description": (
                    "The API server creates a server-side Jarvis AIAgent; "

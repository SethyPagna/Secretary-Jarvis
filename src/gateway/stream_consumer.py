...
class GatewayStreamConsumer:
    ...
    # Must stay in sync with src/jarvis_cli/terminal.py _OPEN_TAGS/_CLOSE_TAGS and
    # src/agent/runtime.py _strip_think_blocks() tag variants.
    _OPEN_THINK_TAGS = (
    ...
    # response (src/agent/runtime.py _strip_think_blocks), but the stream
            ...
            if self._in_think_block:
                ...
                for tag in self._OPEN_THINK_TAGS:
                    ...
                    while True:
                        ...
                        if idx == -1:
                            break
                        # Block-boundary check (mirrors src/jarvis_cli/terminal.py logic)
                        if idx == 0:
                            is_boundary = (
    ...
    # src/gateway/platforms/base.py for post-processing.
    ...
    async def _send_commentary(self, text: str) -> bool:
        ...
        try:
            ...
            # multiple tool calls. See: https://github.com/JARVISProject/jarvis-agent/issues/10454
            if result.success:
    ...
    async def _send_or_edit(self, text: str, *, finalize: bool = False) -> bool:
        ...
        # finishes (via _deliver_media_from_response in src/gateway/run.py).
        text = self._clean_for_display(text)

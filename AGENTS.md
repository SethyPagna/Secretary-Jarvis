...
**Logs:** `~/.jarvis/logs/` — `agent.log` (INFO+), `errors.log` (WARNING+),
...
Jarvis-Agent ensures caching remains valid throughout a conversation. **Do NOT implement changes that would:**

    ...
    in {
      ...
      checks = {
        ...
        bundled-skills = pkgs.runCommand "jarvis-bundled-skills" { } ''
          ...
          test -d ${jarvis-agent}/share/jarvis-agent/skills || (echo "FAIL: skills directory missing"; exit 1)
          echo "PASS: skills directory exists"

          SKILL_COUNT=$(find ${jarvis-agent}/share/jarvis-agent/skills -name "SKILL.md" | wc -l)
        ...
        bundled-plugins = pkgs.runCommand "jarvis-bundled-plugins" { } ''
          ...
          test -d ${jarvis-agent}/share/jarvis-agent/plugins || (echo "FAIL: plugins directory missing"; exit 1)
          echo "PASS: plugins directory exists"

          test -f ${jarvis-agent}/share/jarvis-agent/plugins/platforms/irc/plugin.yaml || \
        ...
        managed-guard = pkgs.runCommand "jarvis_managed-guard" { } ''
          set -e
          export HOME=$(mktemp -d)

...
from jarvis_cli.constants import get_config_path, get_skills_dir, is_termux
    ...
    Args:
        platform: Explicit platform name (e.g. ``"telegram"``).  When
            *None*, resolves from ``JARVIS_PLATFORM`` or
            ``JARVIS_SESSION_PLATFORM`` env vars.  Falls back to the
...
def iter_skill_index_files(skills_dir: Path, filename: str):
    ...
    Excludes Jarvis metadata, VCS, virtualenv/dependency, and cache

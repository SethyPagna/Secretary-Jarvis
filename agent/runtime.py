...
# agent/runtime.py directly as a CLI) — it is NOT needed for library usage.
...
def main(
    ...
    if list_tools:
        ...
        print("  python agent/runtime.py --enabled_toolsets=research --query='search for Python news'")
        print("  python agent/runtime.py --enabled_toolsets=development --query='debug this code'")
        print("  python agent/runtime.py --enabled_toolsets=safe --query='analyze without terminal'")
        print("  ")
        print("  # Combine multiple toolsets")
        print("  python agent/runtime.py --enabled_toolsets=web,vision --query='analyze website'")
        print("  ")
        print("  # Disable toolsets")
        print("  python agent/runtime.py --disabled_toolsets=terminal --query='no command execution'")
        print("  ")
        print("  # Run with trajectory saving enabled")
        print("  python agent/runtime.py --save_trajectories --query='your question here'")
        return

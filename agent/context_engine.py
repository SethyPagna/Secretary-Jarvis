...
class ContextEngine(ABC):
    ...
    # -- Token state (read by agent/runtime.py for display/logging) ------------
    #
    # Engines MUST maintain these. agent/runtime.py reads them directly.
    ...
    # -- Compaction parameters (read by agent/runtime.py for preflight) --------
    #
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        Default returns the standard fields agent/runtime.py expects.
        """
        return {

...
Usage:
    ...
    python ops/scripts/release/contributor_audit.py --since-tag v2026.4.8

    # Audit with a custom endpoint
    python ops/scripts/release/contributor_audit.py --since-tag v2026.4.8 --until v2026.4.13

    # Compare against a release notes file
    python ops/scripts/release/contributor_audit.py --since-tag v2026.4.8 --release-file RELEASE_v0.9.0.md
"""
...
def main():
    ...
    if args.strict and all_unknowns:
        ...
        if new_unknowns:
            ...
            print("Add these to AUTHOR_MAP in ops/scripts/release/release.py before merging:")
            print()

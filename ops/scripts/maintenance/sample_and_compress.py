...
DEFAULT_DATASETS = [
    "JARVISProject/swe-terminus-agent-glm-kimi-minimax",
    "JARVISProject/jarvis-agent-megascience-sft1",
    "JARVISProject/Jarvis-Agent-Thinking-GLM-4.7-SFT2",
    "JARVISProject/Jarvis-Agent-Thinking-GLM-4.7-SFT1",
    "JARVISProject/terminal-tasks-glm-jarvis-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "JARVISProject/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload JARVISProject/{output_name} {final_output}")

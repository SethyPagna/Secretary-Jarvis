 ...
 *
 * Endpoints (matches src/gateway/platforms/whatsapp.py expectations):
...
const IMAGE_CACHE_DIR = path.join(process.env.HOME || '~', '.jarvis', 'image_cache');
const DOCUMENT_CACHE_DIR = path.join(process.env.HOME || '~', '.jarvis', 'document_cache');
const AUDIO_CACHE_DIR = path.join(process.env.HOME || '~', '.jarvis', 'audio_cache');
